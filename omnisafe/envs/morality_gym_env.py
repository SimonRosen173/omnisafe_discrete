...
class MoralityGymOmniSafeEnv(CMDP):
    ...
    _support_envs: ClassVar[list[str]] = [
        # Valid IDs based on morality-gym-tabular/experiments/baselines/configs/Switch3-v0.json
        "Switch3-v0::Trolley-Common-Utilitarian-OrderedUtilityHarm-v0::0",
        "Switch3-v0::Trolley-Common-Utilitarian-OrderedOutcomeHarm1-v0::0",
        "PushStandard-v0::Trolley-Common-DualProcess-Simple-v0::0",
        "PushStandard-v0::Trolley-Common-DualProcess-Complex-v0::0",
        "PushStandard-v0::Trolley-Common-Utilitarian-OrderedUtilityHarm-v0::0",
        "PushStandard-v0::Trolley-Common-Utilitarian-OrderedOutcomeHarm1-v0::0",
        "SwitchStandard-v0::Trolley-Common-Utilitarian-OrderedUtilityHarm-v0::0",
        "SwitchStandard-v0::Trolley-Common-Utilitarian-OrderedOutcomeHarm1-v0::0",
        "Switch7-v0::Trolley-Common-Utilitarian-OrderedUtilityHarm-v0::0",
